...
dir = '/vols/cms02/elaird1/29_skims/08_mumu/v1'
mumu.add("DoubleMu.Run2011A-05Aug2011-v1.AOD.job663_skim",   '%s"%s/DoubleMu.Run2011A-05Aug2011-v1.AOD.job663_*_skim.root",  )'%(l, dir), lumi = 3.567000e+02)
mumu.add("DoubleMu.Run2011A-May10ReReco-v1.AOD.job662_skim", '%s"%s/DoubleMu.Run2011A-May10ReReco-v1.AOD.job662_*_skim.root",)'%(l, dir), lumi = 2.023000e+02)
mumu.add("DoubleMu.Run2011A-PromptReco-v4.AOD.job664_skim",  '%s"%s/DoubleMu.Run2011A-PromptReco-v4.AOD.job664_*_skim.root", )'%(l, dir), lumi = 8.515000e+02)
mumu.add("DoubleMu.Run2011A-PromptReco-v6.AOD.job665_skim",  '%s"%s/DoubleMu.Run2011A-PromptReco-v6.AOD.job665_*_skim.root", )'%(l, dir), lumi = 6.173000e+02)
mumu.add("DoubleMu.Run2011B-PromptReco-v1.AOD.job666_skim",  '%s"%s/DoubleMu.Run2011B-PromptReco-v1.AOD.job666_*_skim.root", )'%(l, dir), lumi = 2.545200e+03)
