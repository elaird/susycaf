...
susy17.add("t1tttt.job442", '%s/yeshaq//ICF/automated/2012_10_04_23_15_25/")'%pnfs, xs = {"LO":107.5}["LO"]) #dummy xs
susy17.add("t1bbbb.job443", '%syeshaq//ICF/automated/2012_10_04_22_34_28/")'%pnfs, xs = {"LO":107.5}["LO"]) #dummy xs                                                  
susy17.add("t1.job444", '%s/yeshaq//ICF/automated/2012_10_04_23_04_08/")'%pnfs, xs = {"LO":107.5}["LO"]) #dummy xs
