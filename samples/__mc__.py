...
#mc.add("tt_tauola_fj", '%s/arlogb//ICF/automated/2011_07_11_17_17_07/")'%srm,    xs = {"LO":94,    "BurtGuessNLO":157.5}["BurtGuessNLO"])#in __top__
...
#mc.add("tt_tauola_fj_mg",'%s/bbetchar//ICF/automated/2011_07_20_22_27_52/")'%srm, xs = 319.18) #in __top__
#mc.add("w_jets_fj_mg", '%s/gouskos//ICF/automated/2011_07_18_17_43_04/")'%srm, xs = 55854) #in __ewk__
