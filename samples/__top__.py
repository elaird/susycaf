...
top.add("ttbar_mg", '/2011_12_08_08_31_06/")'%srm_burt , xs = {"LO":94.76, "guessNLO":157.5 }['guessNLO'] )
...
# Summer2011
top.add("tt_tauola_fj_mg",'%s/2011_07_20_22_27_52/")'%srm_burt, xs = xs = { "LO":94.76, "guessNLO":157.5}["guessNLO"] )
