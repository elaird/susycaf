import supy,steps,calculables,samples,copy,os, ROOT as r

class hadronicLookEps(supy.analysis) :
    def parameters(self) :
        objects = self.vary()
    ...
    def listOfSteps(self, params) :
        ...
        return scanBefore + [
            ...
            steps.ket.uniquelyMatchedNonisoMuons(_jet), 
